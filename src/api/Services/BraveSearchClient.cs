...
public class BraveSearchClient(
    ...
    ILogger<BraveSearchClient> logger) : IBraveSearchClient
{
    public async Task<List<BraveSearchResultItem>> SearchAsync(string query, CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            return results.EnumerateArray()
                .Select(r => new BraveSearchResultItem(

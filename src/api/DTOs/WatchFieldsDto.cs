...
/// <summary>Fields shared by create and full-replacement watch requests.</summary>
public abstract class WatchFieldsDto
{
    ...
    [EnumDataType(typeof(AcquisitionType))] public AcquisitionType AcquisitionType { get; set; } = AcquisitionType.New;
    [StringLength(200)] public string? AcquiredFrom { get; set; }
    [StringLength(2000), Url] public string? AcquisitionSourceUrl { get; set; }
    [StringLength(10000)] public string? Notes { get; set; }
    [StringLength(100)] public string? CrystalType { get; set; }
    ...
    [Range(1, 200)] public double? LugToLugMm { get; set; }
    [StringLength(100)] public string? DialColor { get; set; }
    [StringLength(100)] public string? BezelType { get; set; }
    [Range(0, 10000)] public int? PowerReserveHours { get; set; }
